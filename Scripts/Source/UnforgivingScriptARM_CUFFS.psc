Scriptname UnforgivingScriptARM_CUFFS
    ...
    EndFunction
        ...
        Function LOCK_ABADON_CUFFS_ARMS(Actor akOriginator, string contextJson, string paramsJson) global
            ...
            return
            EndIf
            Armor deviceInventory=(Game.GetFormFromFile(0x091342d7, "UnforgivingDevices.esp") as Armor);
            Debug.Trace("[DeviousStuff] LOCK_ABADON_CUFFS_ARMS called for " + akOriginator.GetDisplayName())
            Debug.Trace("[DeviousStuff] LOCK_ABADON_CUFFS_ARMS target " + akTarget.GetDisplayName())    
